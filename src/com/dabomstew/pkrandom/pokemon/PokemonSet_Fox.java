...
public class PokemonSet<T extends Pokemon> extends HashSet<T> {
     ...
     */
    public PokemonSet(Collection<? extends T> cloneFrom) {
        super(cloneFrom);
    }
     ...
     */
    public PokemonSet<T> filter(Predicate<? super T> predicate) {
     ...
     */
    public PokemonSet<T> buildSetSingle(Function<? super T, T> function) {
        PokemonSet<T> newSet = new PokemonSet<>();
     ...
     * @return The PokemonSet containing all Pokemon returned after running the given function.
     */
    public PokemonSet<T> buildSet(Function<? super T, PokemonSet<T>> function) {
        PokemonSet<T> newSet = new PokemonSet<>();
     ...
     */
    public PokemonSet<T> filterBuiltSetSingle(Function<? super T, T> function) {
        PokemonSet<T> builtSet = this.buildSetSingle(function);
     ...
     * @return The PokemonSet containing all Pokemon in this set returned after running the given function.
     */
    public PokemonSet<T> filterBuiltSet(Function<? super T, PokemonSet<T>> function) {
        PokemonSet<T> builtSet = this.buildSet(function);
        builtSet.retainAll(this);
        return builtSet;
    }
     ...
     * @return Whether any Pokemon were added to the set.
     */
    public boolean addBuiltSet(Function<? super T, PokemonSet<T>> function) {
        PokemonSet<T> builtSet = this.buildSet(function);
        return this.addAll(builtSet);
    }
     ...
     * @return Whether any Pokemon were removed from the set.
     */
    public boolean removeBuiltSet(Function<? super T, PokemonSet<T>> function) {
        PokemonSet<T> builtSet = this.buildSet(function);
        return this.removeAll(builtSet);
    }
    ...
    /**
     * A class containing many helper methods related to evolution families.
     * These methods can only be used with {@literal PokemonSet<Pokemon>}.
     */
    ...
    public static class EvolutionMethods {
     ...
     */
    public PokemonSet<T> filterNonCosmetic() {
    ...
    private static class UnmodifiablePokemonSet<T extends Pokemon> extends PokemonSet<T> {
        ...
        public UnmodifiablePokemonSet(Collection<T> original) {
            super(original);
