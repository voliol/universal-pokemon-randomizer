    ...
    public List<Pokemon> getStarters() {
        ...
        try {
            ...
            List<Integer> starterIndices =
                    Arrays.stream(romEntry.getArrayValue("StarterIndices")).boxed().collect(Collectors.toList());
...
//                }
    ...
    private void fixBoxLegendariesXY(int boxLegendarySpecies) throws IOException {
        ...
        for (int boxLegendaryScriptOffset : boxLegendaryScriptOffsets) {
            FileFunctions.write2ByteInt(data, boxLegendaryScriptOffset, boxLegendarySpecies);
        }
