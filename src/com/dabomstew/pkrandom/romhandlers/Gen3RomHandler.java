...
//        }
    ...
    private void changePlayerOverworldImage(Gen3PlayerCharacterGraphics pcg,
        ...
        int firstImageNumber = romEntry.getIntValue(pcg.getPlayerToReplaceName() + key);
    ...
    private void changePlayerOverworldPalettes(Gen3PlayerCharacterGraphics pcg)  {
        ...
        int normalPaletteNumber = romEntry.getIntValue(pcg.getPlayerToReplaceName() + "NormalPalette");
        ...
        int reflectionPaletteNumber = romEntry.getIntValue(pcg.getPlayerToReplaceName() + "ReflectionPalette");
	...
	private void changePlayerTrainerImages(Gen3PlayerCharacterGraphics pcg) {
        ...
        int playerTrainerBackNumber = romEntry.getIntValue(pcg.getPlayerToReplaceName() + "BackImage");
    ...
    private void changePlayerMapIcon(Gen3PlayerCharacterGraphics pcg) {
        ...
        int iconImageOffset = romEntry.getIntValue(pcg.getPlayerToReplaceName() + "MapIconImage");
        writeBytes(iconImageOffset, GFXFunctions.readTiledImageData(image));
        Palette palette = pcg.getMapIconPalette();
        int iconPaletteOffset = romEntry.getIntValue(pcg.getPlayerToReplaceName() + "MapIconPalette");
