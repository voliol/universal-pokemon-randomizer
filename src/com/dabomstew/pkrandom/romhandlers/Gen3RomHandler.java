...
public class Gen3RomHandler extends AbstractGBRomHandler {
    ...
    public List<Trainer> getTrainers() {
        ...
        if (romEntry.getRomType() == Gen3Constants.RomType_Ruby || romEntry.getRomType() == Gen3Constants.RomType_Sapp) {
            Gen3Constants.trainerTagsRS(theTrainers, romEntry.getRomType());
    ...
    public void setTrainers(List<Trainer> trainerData, boolean doubleBattleMode) {
        ...
        int fso = romEntry.getIntValue("FreeSpace");
    ...
    public void setTMMoves(List<Integer> moveIndexes) {
        ...
        int fsOffset = romEntry.getIntValue("FreeSpace");
    ...
    public void randomizeIntroPokemon() {
        ...
        if (romEntry.getRomType() == Gen3Constants.RomType_FRLG) {
            ...
            rom[romEntry.getIntValue("IntroOtherOffset")] = (byte) introPokemon;
    ...
    private void applyRunningShoesIndoorsPatch() {
        if (romEntry.getIntValue("RunIndoorsTweakOffset") != 0) {
            rom[romEntry.getIntValue("RunIndoorsTweakOffset")] = 0x00;
        }
    }
    ...
    private int repointAndWriteToFreeSpace(int pointerOffset, byte[] data) {
        int freeSpaceOffset = romEntry.getIntValue("FreeSpace");
