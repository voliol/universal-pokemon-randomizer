...
public class Gen3RomHandler extends AbstractGBRomHandler {
    ...
    private final static String emOverworldPaletteBytes = "0E535F5B1F4B5B3A0F219F5ABA3D1129127B2B5EC2289632CF21E70CFF7F0000";
    ...
    private void findFRLGPlayerGraphicsOffsets() {
        ...
        GBAImage surf = null;
        try {
            surf = new GBAImage(ImageIO.read(new File("surf_blob.png"))).getSubimageFromFrame(0, 4, 4);
        } catch (IOException ignored) {
        }
    ...
    private void setFRLGCustomPlayerGraphics(Gen3PlayerCharacterGraphics unchecked, Settings.PlayerCharacterMod toReplace) {
        ...
        if (playerGraphics.hasSurfBlobSprite()) {
            writePlayerSurfBlobSprite(playerGraphics.getSurfBlobSprite(), toReplace);
        }
    ...
    private void writePlayerSurfBlobSprite(GBAImage sprite, Settings.PlayerCharacterMod toReplace) {
