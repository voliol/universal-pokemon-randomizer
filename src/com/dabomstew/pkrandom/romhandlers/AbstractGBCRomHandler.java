...
public abstract class AbstractGBCRomHandler extends AbstractGBRomHandler {
    ...
    protected abstract static class AbstractGBCRomEntry extends RomEntry {
        ...
        public void addTMText(TMTextEntry tte)  {
            tmTexts.add(tte);
        }

        public List<TMTextEntry> getTMTexts() {
    ...
    protected static class TMTextEntry {
        private final int number, offset;
        private final String template;

        public TMTextEntry(int number, int offset, String template) {
            this.number = number;
            this.offset = offset;
