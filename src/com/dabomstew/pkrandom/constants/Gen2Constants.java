...
public class Gen2Constants {
    ...
    public static final Map<Integer,Integer> balancedItemPrices = Stream.of(new Integer[][] {
            ...
            {Gen2Items.antidote, 100},
            {Gen2Items.burnHeal, 250},
            {Gen2Items.iceHeal, 250},
            {Gen2Items.awakening, 250},
            {Gen2Items.parlyzHeal, 200},
            {Gen2Items.fullRestore, 3000},
            {Gen2Items.maxPotion, 2500},
            {Gen2Items.hyperPotion, 1200},
            {Gen2Items.superPotion, 700},
            {Gen2Items.potion, 300},
            {Gen2Items.escapeRope, 550},
            {Gen2Items.repel, 350},
            {Gen2Items.maxElixer, 4500},
            {Gen2Items.fireStone, 2100},
            {Gen2Items.thunderstone, 2100},
            {Gen2Items.waterStone, 2100},
            {Gen2Items.terusama25, 0},
            {Gen2Items.hpUp, 9800},
            {Gen2Items.protein, 9800},
            {Gen2Items.iron, 9800},
            {Gen2Items.carbos, 9800},
            {Gen2Items.luckyPunch, 0}, // TODO
            {Gen2Items.calcium, 9800},
            {Gen2Items.rareCandy, 4800}, // TODO balanced?
            {Gen2Items.xAccuracy, 950},
            {Gen2Items.leafStone, 2100},
            {Gen2Items.metalPowder, 0}, // TODO
            {Gen2Items.nugget, 10000},
            {Gen2Items.pokeDoll, 1000},
            {Gen2Items.fullHeal, 600},
            {Gen2Items.revive, 1500},
            {Gen2Items.maxRevive, 4000},
            {Gen2Items.guardSpec, 700},
            {Gen2Items.superRepel, 500},
            {Gen2Items.maxRepel, 700},
            {Gen2Items.direHit, 650},
            {Gen2Items.terusama45, 0},
            {Gen2Items.freshWater, 200},
            {Gen2Items.sodaPop, 300},
            {Gen2Items.lemonade, 350},
            {Gen2Items.xAttack, 500},
            {Gen2Items.terusama50, 0},
            {Gen2Items.xDefend, 550},
            {Gen2Items.xSpeed, 350}, // TODO: all prices below
            {Gen2Items.xSpecial, 350},
            {Gen2Items.coinCase, 350},
            {Gen2Items.itemfinder, 350},
            {Gen2Items.terusama56, 350},
            {Gen2Items.expShare, 350},
            {Gen2Items.oldRod, 350},
            {Gen2Items.goodRod, 350},
            {Gen2Items.silverLeaf, 350},
            {Gen2Items.superRod, 350},
            {Gen2Items.ppUp, 350},
            {Gen2Items.ether, 350},
            {Gen2Items.maxEther, 350},
            {Gen2Items.elixer, 350},
            {Gen2Items.redScale, 350},
            {Gen2Items.secretPotion, 350},
            {Gen2Items.ssTicket, 350},
            {Gen2Items.mysteryEgg, 350},
            {Gen2Items.clearBell, 350},
            {Gen2Items.silverWing, 350},
            {Gen2Items.moomooMilk, 350},
            {Gen2Items.quickClaw, 350},
            {Gen2Items.psnCureBerry, 350},
            {Gen2Items.goldLeaf, 350},
            {Gen2Items.softSand, 350},
            {Gen2Items.sharpBeak, 350},
            {Gen2Items.przCureBerry, 350},
            {Gen2Items.burntBerry, 350},
            {Gen2Items.iceBerry, 350},
            {Gen2Items.poisonBarb, 350},
            {Gen2Items.kingsRock, 350},
            {Gen2Items.bitterBerry, 350},
            {Gen2Items.mintBerry, 350},
            {Gen2Items.redApricorn, 350},
            {Gen2Items.tinyMushroom, 350},
            {Gen2Items.bigMushroom, 350},
            {Gen2Items.bluApricorn, 350},
            {Gen2Items.terusama90, 350},
            {Gen2Items.amuletCoin, 350},
            {Gen2Items.ylwApricorn, 350},
            {Gen2Items.grnApricorn, 350},
            {Gen2Items.cleanseTag, 350},
            {Gen2Items.mysticWater, 350},
            {Gen2Items.twistedSpoon, 350},
            {Gen2Items.whtApricorn, 350},
            {Gen2Items.blackbelt, 350},
            {Gen2Items.blkApricorn, 350},
            {Gen2Items.terusama100, 350},
            {Gen2Items.pnkApricorn, 350},
            {Gen2Items.blackGlasses, 350},
            {Gen2Items.slowpokeTail, 350},
            {Gen2Items.pinkBow, 350},
            {Gen2Items.stick, 350},
            {Gen2Items.smokeBall, 350},
            {Gen2Items.neverMeltIce, 350},
            {Gen2Items.magnet, 350},
            {Gen2Items.miracleBerry, 350},
            {Gen2Items.pearl, 350},
            {Gen2Items.bigPearl, 350},
            {Gen2Items.everstone, 350},
            {Gen2Items.spellTag, 350},
            {Gen2Items.rageCandyBar, 350},
            {Gen2Items.gsBall, 350},
            {Gen2Items.blueCard, 350},
            {Gen2Items.miracleSeed, 350},
            {Gen2Items.thickClub, 350},
            {Gen2Items.focusBand, 350},
            {Gen2Items.terusama120, 350},
            {Gen2Items.energyPowder, 350},
            {Gen2Items.energyRoot, 350},
            {Gen2Items.healPowder, 350},
            {Gen2Items.revivalHerb, 350},
            {Gen2Items.hardStone, 350},
            {Gen2Items.luckyEgg, 350},
            {Gen2Items.cardKey, 350},
            {Gen2Items.machinePart, 350},
            {Gen2Items.eggTicket, 350},
            {Gen2Items.lostItem, 350},
            {Gen2Items.stardust, 350},
            {Gen2Items.starPiece, 350},
            {Gen2Items.basementKey, 350},
            {Gen2Items.pass, 350},
            {Gen2Items.terusama135, 350},
            {Gen2Items.terusama136, 350},
            {Gen2Items.terusama137, 350},
            {Gen2Items.charcoal, 350},
            {Gen2Items.berryJuice, 350},
            {Gen2Items.scopeLens, 350},
            {Gen2Items.terusama141, 350},
            {Gen2Items.terusama142, 350},
            {Gen2Items.metalCoat, 350},
            {Gen2Items.dragonFang, 350},
            {Gen2Items.terusama145, 350},
            {Gen2Items.leftovers, 350},
            {Gen2Items.terusama147, 350},
            {Gen2Items.terusama148, 350},
            {Gen2Items.terusama149, 350},
            {Gen2Items.mysteryBerry, 350},
            {Gen2Items.dragonScale, 350},
            {Gen2Items.berserkGene, 350},
            {Gen2Items.terusama153, 350},
            {Gen2Items.terusama154, 350},
            {Gen2Items.terusama155, 350},
            {Gen2Items.sacredAsh, 350},
            {Gen2Items.heavyBall, 350},
            {Gen2Items.flowerMail, 350},
            {Gen2Items.levelBall, 350},
            {Gen2Items.lureBall, 350},
            {Gen2Items.fastBall, 350},
            {Gen2Items.terusama162, 350},
            {Gen2Items.lightBall, 350},
            {Gen2Items.friendBall, 350},
            {Gen2Items.moonBall, 350},
            {Gen2Items.loveBall, 350},
            {Gen2Items.normalBox, 350},
            {Gen2Items.gorgeousBox, 350},
            {Gen2Items.sunStone, 350},
            {Gen2Items.polkadotBow, 350},
            {Gen2Items.terusama171, 350},
            {Gen2Items.upGrade, 350},
            {Gen2Items.berry, 350},
            {Gen2Items.goldBerry, 350},
            {Gen2Items.squirtBottle, 350},
            {Gen2Items.terusama176, 350},
            {Gen2Items.parkBall, 350},
            {Gen2Items.rainbowWing, 350},
            {Gen2Items.terusama179, 350},
            {Gen2Items.brickPiece, 350},
            {Gen2Items.surfMail, 350},
            {Gen2Items.litebluemail, 350},
            {Gen2Items.portraitmail, 350},
            {Gen2Items.lovelyMail, 350},
            {Gen2Items.eonMail, 350},
            {Gen2Items.morphMail, 350},
            {Gen2Items.blueskyMail, 350},
            {Gen2Items.musicMail, 350},
            {Gen2Items.mirageMail, 350},
            {Gen2Items.terusama190, 350},
            {Gen2Items.tm01, 350},
            {Gen2Items.tm02, 350},
            {Gen2Items.tm03, 350},
            {Gen2Items.tm04, 350},
            {Gen2Items.tm04Unused, 350},
            {Gen2Items.tm05, 350},
            {Gen2Items.tm06, 350},
            {Gen2Items.tm07, 350},
            {Gen2Items.tm08, 350},
