...
public class Gen2Constants {
    ...
    // 0x14 ends with "Egg Pic", which is "Unused Egg Pic" in crystal
    public static final int[] gsBanksEndingWithImages = new int[]{0x12, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C,
            0x1D, 0x1E, 0x1F, 0x20}, crystalBanksEndingWithImages = new int[]{0xA, 0x14, 0x48, 0x49, 0x4A, 0x4B, 0x4C,
