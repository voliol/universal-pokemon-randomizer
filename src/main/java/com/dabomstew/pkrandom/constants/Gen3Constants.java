...
public class Gen3Constants {
        ...
        public static final byte[] emptyPokemonSig = new byte[] {0x32, (byte) 0x96, 0x32,
                        ...
                        0x00, 0x00, 0x00, 0x00, (byte) 0xFF, 0x78, 0x00, 0x00, 0x0F, 0x0F, 0x00,
        ...
        public static final int bsHPOffset = 0, bsAttackOffset = 1, bsDefenseOffset = 2,
                        ...
                        bsPrimaryTypeOffset = 6, bsSecondaryTypeOffset = 7, bsCatchRateOffset = 8,
                        bsCommonHeldItemOffset = 12, bsRareHeldItemOffset = 14,
                        bsGenderRatioOffset = 16, bsGrowthCurveOffset = 19, bsAbility1Offset = 22,
                        bsAbility2Offset = 23;
        ...
        public static final List<Integer> frlgRequiredFieldTMs =
                        Arrays.asList(new Integer[] {1, 2, 7, 8, 9, 11, 12, 14, 17, 18, 21, 22, 25,
                                        32, 36, 37, 40, 41, 44, 46, 47, 48, 49, 50});
        ...
        private static void setupAllowedItems() {
                ...
                trainerItemList.allowSingles(142, 168, 169); // SITRUS BERRY, LIECHI BERRY, GANLON
                                                             // BERRY
                trainerItemList.allowSingles(170, 171, 172); // SALAC BERRY, PETAYA BERRY, APICOT
                                                             // BERRY
                trainerItemList.allowSingles(173, 174, 175); // LANSAT BERRY, STARF BERRY, ENIGMA
                                                             // BERRY
                trainerItemList.allowSingles(179, 180, 183); // BRIGHTPOWDER, WHITE HERB, QUICK CLAW
                trainerItemList.allowSingles(186, 187, 188); // CHOICE BAND, KING's ROCK,
                                                             // SILVERPOWDER
                ...
                trainerItemList.allowSingles(205, 206, 207); // MIRACLE SEED, BLACKGLASSES, BLACK
                                                             // BELT
        ...
        public static void trainerTagsE(List<Trainer> trs) {
                ...
                tag(trs, "GYM7", 0xE9, 0xEA, 0xEB, 0xF4, 0xF5, 0xF6, 0x24F, 0x248, 0x247, 0x249,
                                0x246, 0x23F);
