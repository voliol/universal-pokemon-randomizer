...
/**
 * Please note that certain characters need to be redefined with their Unicode hexidecimal number
 * (such as é is x00E9). If you encounter issues with characters not being convertable into numbers,
 * please use this site to look up the conversion code https://unicodemap.org/
 * 
 * Successful translation requires maintaining the proper spacing characters (such as
 * \xf000븀\x0000\xfffe). It is easy to start with the original text by exporting a/0/0/3 from the
 * ROM (using a tool like NitroExplorer2) and opening it up in PPTxt, then copying that into here.
 */
...
public class Gen5TextHandler {
    ...
    public void bw1StriatonCityTextModifications(Map<String, Type> taggedGroupTypes) {
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymLeaderSpeech.set(Gen5Constants.bw1StriatonCityGymTextOffset,
                        "I'm Chili! I light things up with\\xFFFE"
                                + taggedGroupTypes.get("CHILI").camelCase() + "-type Pok\\x00E9mon!"
                                + MINOR_LINE_BREAK);
                gymLeaderSpeech.set(Gen5Constants.bw1StriatonCityGymTextOffset + 1,
                        "I'm a " + taggedGroupTypes.get("CRESS").camelCase()
                                + "-type specialist,\\xFFFEand my name is Cress." + MAJOR_LINE_BREAK
                                + "Pleased " + "to make your acquaintance." + MINOR_LINE_BREAK);
                gymLeaderSpeech.set(Gen5Constants.bw1StriatonCityGymTextOffset + 2,
                        "And my name is Cilan.\\xFFFEI like "
                                + taggedGroupTypes.get("CILAN").camelCase() + "-type Pok\\x00E9mon."
                                + MINOR_LINE_BREAK);
                ...
                gymLeaderSpeech.set(Gen5Constants.bw1StriatonCityGymText2Offset + 2,
                        "Nothing personal... No hard feelings...\\xFFFEMe and my "
                                ...
                                + "-type Pok\\x00E9mon will...um..." + MAJOR_LINE_BREAK
                                + "We're gonna battle, " + "come what may." + MINOR_LINE_BREAK);
            }
        }
        // Types are not available - Make any type references generic
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymLeaderSpeech.set(Gen5Constants.bw1StriatonCityGymTextOffset,
                        "I'm Chili! I light things up with\\xFFFE" + "hot Pok\\x00E9mon!"
                                + MINOR_LINE_BREAK);
                gymLeaderSpeech.set(Gen5Constants.bw1StriatonCityGymTextOffset + 1,
                        "I'm a general specialist,\\xFFFEand my name is Cress." + MAJOR_LINE_BREAK
                                + "Pleased " + "to make your acquaintance." + MINOR_LINE_BREAK);
                gymLeaderSpeech.set(Gen5Constants.bw1StriatonCityGymTextOffset + 2,
                        "And my name is Cilan.\\xFFFEI like " + "any Pok\\x00E9mon."
                                + MINOR_LINE_BREAK);
                gymLeaderSpeech.set(Gen5Constants.bw1StriatonCityGymText2Offset,
                        "Ta-da! The jalape\\x00F1o scorcher "
                                + "Chili--\\xFFFEthat's me--will be your " + "opponent!"
                                + MINOR_LINE_BREAK);
                gymLeaderSpeech.set(Gen5Constants.bw1StriatonCityGymText2Offset + 1,
                        "That is correct!" + MAJOR_LINE_BREAK + "It shall "
                ...
                gymLeaderSpeech.set(Gen5Constants.bw1StriatonCityGymText2Offset + 2,
                        "Nothing personal... No hard feelings...\\xFFFEMe and my "
                                + "favorite Pok\\x00E9mon will...um..." + MAJOR_LINE_BREAK
                                + "We're gonna battle, " + "come what may." + MINOR_LINE_BREAK);
            }
        }
    ...
    public void bw1NacreneCityTextModifications(Map<String, Type> taggedGroupTypes, Random random) {
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymLeaderSpeech.set(Gen5Constants.bw1NacreneCityGymTextOffset,
                        "All Trainers in this Gym use\\xFFFE"
                                ...
                                + MAJOR_LINE_BREAK + "This " + "is just between you and me..."
                                + MAJOR_LINE_BREAK + taggedGroupTypes.get("GYM2").camelCase()
                                + "-type Pok\\x00E9mon are weak against\\xFFFE"
                                + Type.randomWeakness(random, false, taggedGroupTypes.get("GYM2"))
                                        .camelCase()
                                ...
                                + "hidden in books," + MAJOR_LINE_BREAK + "you can move forward."
                                + MAJOR_LINE_BREAK
                ...
                gymLeaderSpeech.set(Gen5Constants.bw1NacreneCityGymTextOffset + 1,
                        "All Trainers in this Gym use\\xFFFE"
                                ...
                                + MAJOR_LINE_BREAK + "you can move forward." + MAJOR_LINE_BREAK
        ...
        // Types are not available - Make any type references generic
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymLeaderSpeech.set(Gen5Constants.bw1NacreneCityGymTextOffset,
                        "All Trainers in this Gym use\\xFFFE" + "awesome Pok\\x00E9mon."
                                + MAJOR_LINE_BREAK + "This is just between you and me..."
                                + MAJOR_LINE_BREAK + "you have awesome Pok\\x00E9mmon too!"
                                + MAJOR_LINE_BREAK + "Now, I will explain "
                                + "about the Gym itself!" + MAJOR_LINE_BREAK
                                + "In this Pok\\x00E9mon Gym, if you answer\\xFFFEquestions "
                                + "hidden in books," + MAJOR_LINE_BREAK + "you can move forward."
    ...
    public void bw1CasteliaCityPraiseTextModifications(Map<String, Type> taggedGroupTypes) {
        ...
        if (taggedGroupTypes != null) {
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymPraiseSpeech.set(Gen5Constants.bw1CasteliaCityPraiseTextOffset,
                        "The Striaton City Gym Leaders are a\\xFFFEgreat triplet " + "combo!"
                                + MAJOR_LINE_BREAK + "The "
                                + taggedGroupTypes.get("CILAN").camelCase()
        ...
        // Types are not available - Make any type references generic
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymPraiseSpeech.set(Gen5Constants.bw1CasteliaCityPraiseTextOffset,
                        "The Striaton City Gym Leaders are a\\xFFFEgreat triplet " + "combo!"
                                + MAJOR_LINE_BREAK + "The herbalist, "
                                + "Cilan,\\xFFFEchooses great tea leaves." + MAJOR_LINE_BREAK
                                + "The general specialist, "
                                + "Cress,\\xFFFEprepares the best water." + MAJOR_LINE_BREAK
                                + "And the jalape\\x00F1o "
                                + "scorcher, Chili,\\xFFFEpours hot water at " + "the right heat."
                                + MAJOR_LINE_BREAK + "No " + "wonder their tea is the best!");
            }
        }
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                ...
                gymLeaderSpeech.set(Gen5Constants.bw1CasteliaCityBurghText2Offset,
                        "How many discoveries have you made\\xFFFEsince you "
                                ...
                                + "I continue" + MAJOR_LINE_BREAK + "to discover new " + "things."
                                + MAJOR_LINE_BREAK + "A world shared with "
                ...
                gymLeaderSpeech.set(Gen5Constants.bw1CasteliaCityBurghText3Offset,
                        "If you hadn't stepped on that switch,\\xFFFEI'd still be "
                                + "stuck hidden away." + MAJOR_LINE_BREAK + "That's " + "right! "
        ...
        if (taggedGroupTypes != null) {
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymLeaderSpeech.set(Gen5Constants.bw1CherenBurghTextOffset,
                        "He's a seasoned Gym Leader.\\xFFFEHe made me work for " + "that Gym Badge!"
                                + MAJOR_LINE_BREAK + "But for me, "
                                + taggedGroupTypes.get("GYM3").camelCase()
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymLeaderSpeech.set(Gen5Constants.bw1NimbasaCityTextOffset,
                        "In this roller coaster Gym, the first\\xFFFEstep "
                                ...
                                + "Next comes the platform!\\xFFFEThere, you can " + "change"
                                + MAJOR_LINE_BREAK + "where the " + "coaster is going!"
                                + MAJOR_LINE_BREAK
                                + "Sometimes you continue by riding\\xFFFEthe cars "
                                + "of opponents you defeat." + MAJOR_LINE_BREAK
                                + "That's how you aim for the Gym Leader!" + MAJOR_LINE_BREAK
                                + "By the way, " + taggedGroupTypes.get("GYM4").camelCase()
                                + "-type Pok\\x00E9mon don't\\xFFFEdo well against "
                                + Type.randomWeakness(random, false, taggedGroupTypes.get("GYM4"))
                                        .camelCase()
                                + "-type moves...");
                gymLeaderSpeech.set(Gen5Constants.bw1NimbasaCityTextOffset + 1,
                        "Elesa uses dazzling\\xFFFE" + taggedGroupTypes.get("GYM4").camelCase()
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymLeaderSpeech.set(Gen5Constants.bw1NimbasaCityTextOffset,
                        "In this roller coaster Gym, the first\\xFFFEstep "
                                ...
                                + "of opponents you defeat." + MAJOR_LINE_BREAK
                                + "That's how you aim for the Gym Leader!" + MAJOR_LINE_BREAK
                                + "By the way, " + "she got moves...");
                gymLeaderSpeech.set(Gen5Constants.bw1NimbasaCityTextOffset + 1,
                        "Elesa uses dazzling\\xFFFE" + "attacks!" + MAJOR_LINE_BREAK + "But "
                                + "the combination of you and your\\xFFFEPok\\x00E9mon "
                                + "was even more impressive!" + MAJOR_LINE_BREAK
                                + "It was... It was...\\xFFFEan emotional roller coaster!");
            }
        ...
        if (taggedGroupTypes != null) {
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                professorSpeech.set(Gen5Constants.bw1JuniperElesaTextOffset,
                        "Professor Juniper: Elesa called and was" + "\\xFFFEasking me all about "
                                + taggedGroupTypes.get("GYM4").camelCase() + "-type"
                                + MAJOR_LINE_BREAK + "Pok\\x00E9mon, and I "
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                professorSpeech.set(Gen5Constants.bw1JuniperElesaTextOffset,
                        "Professor Juniper: Elesa called and was"
                                + "\\xFFFEasking me all about her favorite " + "type"
                                + MAJOR_LINE_BREAK + "of Pok\\x00E9mon, and I "
                                + "thought about you guys." + MAJOR_LINE_BREAK
                                + "That's why I wanted to see you.\\xFFFETa-da! Freebies for you!"
                                + MINOR_LINE_BREAK);
            }
    ...
    public void bw1DriftveilCityTextModifications(Map<String, Type> taggedGroupTypes,
            Random random) {
        List<String> gymLeaderSpeech =
                getStrings(getRomEntry().getInt("DriftveilLeaderTextOffset"));
        ...
        if (taggedGroupTypes != null) {
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymLeaderSpeech.set(Gen5Constants.bw1DriftveilCityTextOffset,
                        "The Gym Leader Clay uses\\xFFFE" + taggedGroupTypes.get("GYM5").camelCase()
                                + "-type Pok\\x00E9mon!" + MAJOR_LINE_BREAK
                                ...
                                + Type.randomWeakness(random, false, taggedGroupTypes.get("GYM5"))
                                        .camelCase()
        ...
        // Types are not available - Make any type references generic
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymLeaderSpeech.set(Gen5Constants.bw1DriftveilCityTextOffset,
                        "The Gym Leader Clay uses\\xFFFE" + "very strong Pok\\x00E9mon!"
                                + MAJOR_LINE_BREAK + "Well, just between you and me,\\xFFFE"
                                + "those kind of Pok\\x00E9mon aren't good against"
                                + MAJOR_LINE_BREAK + "strategic attacks." + MAJOR_LINE_BREAK
                                + "Kinda makes me wonder why Clay is living\\xFFFEexposed to them.");
            }
        }
    ...
    public void bw1MistraltonCityTextModifications(Map<String, Type> taggedGroupTypes) {
        List<String> gymLeaderSpeech =
                getStrings(getRomEntry().getInt("MistraltonLeaderTextOffset"));
                ...
                gymLeaderSpeech.set(Gen5Constants.bw1MistraltonCityTextOffset,
                        "Just between you and me..." + MAJOR_LINE_BREAK
                                + Type.getWeaknesses(taggedGroupTypes.get("GYM6"), 3).stream()
                                        .map(type -> type.camelCase())
                                        .collect(Collectors.joining(", "))
                                + "... " + taggedGroupTypes.get("GYM6").camelCase()
                                + "-types have\\xFFFEmore weaknesses than people know about."
                                + MAJOR_LINE_BREAK
                                + "If you use Pok\\x00E9mon and moves of those\\xFFFEtypes, "
                                + "victory is practically yours!" + MAJOR_LINE_BREAK
                                + "By the way, "
                                + "to proceed in this Gym,\\xFFFEyou climb in the cannons to move forward."
                                + MAJOR_LINE_BREAK
                                + "The cannons go up, down, left, and right.\\xFFFE"
        ...
        if (taggedGroupTypes != null) {
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                plasmaGormSpeech.set(Gen5Constants.bw1PinwheelForestTextOffset,
                        "Gorm: I am one of the Seven Sages\\xFFFEof Team Plasma." + MAJOR_LINE_BREAK
                                + "Ghetsis, another of the Seven Sages,"
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                plasmaGormSpeech.set(Gen5Constants.bw1PinwheelForestTextOffset,
                        "Gorm: I am one of the Seven Sages\\xFFFEof Team Plasma." + MAJOR_LINE_BREAK
                                ...
                                + "simple Pok\\x00E9mon user " + "Lenora, I say..."
                                + MAJOR_LINE_BREAK + "Know your enemies, "
                                + "know yourself,\\xFFFEand you need not fear the result"
                                + MAJOR_LINE_BREAK + "of a hundred battles..." + MAJOR_LINE_BREAK
                                + "This time, we shall retreat quietly." + MINOR_LINE_BREAK);
            }
            ...
            if (getRomEntry().getRomCode().charAt(3) == 'O') {
                gymLeaderSpeech.set(Gen5Constants.bw1CelestialTowerTextOffset,
                        "I'd like to introduce myself again!" + MAJOR_LINE_BREAK
                                ...
                                + taggedGroupTypes.get("GYM6").camelCase() + "-type Pok\\x00E9mon."
                                + MAJOR_LINE_BREAK
        ...
        if (getRomEntry().getRomCode().charAt(3) == 'O') {
            ...
            yourHouseStrings.set(Gen5Constants.bw1CherenText2Offset,
                    "It's decided. You'll be my opponent...\\xFFFEin our first Pok\\x00E9mon battle!"
                            + MAJOR_LINE_BREAK
                            + "Let's see what you can do, \\xFFFEmy Pok\\x00E9mon!"
                            + MINOR_LINE_BREAK);
        }
    ...
    public void bw1MonkeyTextModifications(List<Pokemon> newStatics,
            Map<String, Type> taggedGroupTypes, Random random) {
        ...
        if (getRomEntry().getRomCode().charAt(3) == 'O') {
            for (int i = 0; i < 3; i++) {
                ...
                if (taggedGroupTypes != null
                        && taggedGroupTypes.containsKey(striatonStrings.get(staticPointer))) {
                    ...
                    if (newStatics.get(staticPointer).secondaryType != null
                            && !Type.STRONG_AGAINST.get(superiorType).contains(staticType)) {
                        staticType = newStatics.get(staticPointer).secondaryType;
                    }
                } else {
                    superiorType = Type.randomStrength(random, false,
                            newStatics.get(staticPointer).primaryType);
                }
                ...
                // The monkey replacement is probably Normal type
                    ...
                    monkeyGuyStrings.set(Gen5Constants.bw1MonkeyGiverTextOffset + i,
                            "OK. Here you go!" + MAJOR_LINE_BREAK + "It can use "
                                    + staticType.camelCase() + "-type moves, "
                                    + "so that\\xFFFEmakes it unremarkable against most types!"
                                    + MINOR_LINE_BREAK);
                }
            }
        }
    ...
    public void bw1CasteliaCityItemTextModifications(List<Pokemon> newStarters) {
        ...
        if (getRomEntry().getRomCode().charAt(3) == 'O') {
            itemGuyStrings.set(Gen5Constants.bw1CasteliaCityItemTextOffset,
                    "You have " + newStarters.get(0).getName() + "! " + "Then I will give you "
    ...
    public void bw2StarterTextModifications(List<Pokemon> newStarters) {
        List<String> starterTownStrings =
                getStrings(getRomEntry().getInt("StarterLocationTextOffset"));
        // Update the text for the English games
        if (getRomEntry().getRomCode().charAt(3) == 'O') {
            for (int i = 0; i < 3; i++) {
                starterTownStrings.set(Gen5Constants.bw2StarterTextOffset - i,
                        "\\xF000\\xBD02\\x0000The " + newStarters.get(i).primaryType.camelCase()
                                + "-type Pok\\x00E9mon\\xFFFE\\xF000\\xBD02\\x0000"
                                + newStarters.get(i).name);
            }
