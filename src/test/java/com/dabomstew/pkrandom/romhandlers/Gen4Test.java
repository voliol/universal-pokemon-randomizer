...
public class Gen4Test {
        ...
        public void TestGen4ChangeMethods() throws IOException {
                ...
                romhandler.getMainPokemonList().forEach(pk -> {
                        ...
                        pk.evolutionsFrom.forEach(evo -> {
                                ...
                                assertTrue(evo.type + " was not available in Gen 4",
                                                EvolutionType.isInGeneration(4, evo.type));
        ...
        /**
         * Test Gen4 change methods is correctly affected by remove impossible evos no duplicate
